...
app.use((req, res, next) => {
    res.setHeader(
        ...
        "default-src 'self' 'unsafe-inline' data:; style-src 'self' https://fonts.googleapis.com; connect-src 'self' https://deckofcardsapi.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' https://deckofcardsapi.com"
    )
    next()
})
